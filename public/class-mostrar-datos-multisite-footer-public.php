 ...
 * @subpackage Mostrar_Datos_Multisite_Footer/public
 */
 ...
 */
class Mostrar_Datos_Multisite_Footer_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/mostrar-datos-multisite-footer-public.css', array(), $this->version, 'all' );
